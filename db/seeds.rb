...
d = Driver.find_or_create_by(name: 'Juan', phone: '1', email: 'asd@asd.asd', max_stops: 5)
v = Vehicle.find_or_create_by(capacity: 20, load_type: 'General', driver_id: d.id)
d.vehicle_id = v.id
d.save

Driver.find_or_create_by(name: 'Jose', phone: '1', email: 'asd@asd.asd', cities: 'Huechuraba, Las Condes', max_stops: 10)
Driver.find_or_create_by(name: 'Nicolas', phone: '1', email: 'asd@asd.asd', max_stops: 2)
d = Driver.find_or_create_by(name: 'Hola', phone: '1', email: 'asd@asd.asd', cities: 'Providencia, Vitacura, Nunoa', max_stops: 1)
v = Vehicle.find_or_create_by(capacity: 25, load_type: 'Refrigerado', driver_id: d.id)
d.vehicle_id = v.id
d.save

d = Driver.find_or_create_by(name: 'Chao', phone: '1', email: 'asd@asd.asd', max_stops: 5)
v = Vehicle.find_or_create_by(capacity: 10, load_type: 'General', driver_id: d.id)
d.vehicle_id = v.id
d.save

Driver.find_or_create_by(name: 'Diego', phone: '1', email: 'asd@asd.asd', cities: 'Maipu, Cerrillos, Estacion Central, La Cisterna, Lo Espejo', max_stops: 7)
Driver.find_or_create_by(name: 'Pedro', phone: '1', email: 'asd@asd.asd', cities: 'La Cisterna, Lo Espejo, El Bosque')
Driver.find_or_create_by(name: 'Valentina', phone: '1', email: 'asd@asd.asd')
...
Route.find_or_create_by(starts_at: Time.new(2019, 3, 15, 20, 30), ends_at: Time.new(2019, 3, 15, 21, 40), load_type: 'Refrigerado', load_sum: 2, cities: 'La Cisterna, Lo Espejo', stops_amount: 5)
Route.find_or_create_by(starts_at: Time.new(2019, 3, 15, 12, 30), ends_at: Time.new(2019, 3, 15, 14, 40), load_type: 'General', load_sum: 17, cities: 'La Cisterna, Lo Espejo', stops_amount: 1)
Route.find_or_create_by(starts_at: Time.new(2019, 3, 15, 20, 30), ends_at: Time.new(2019, 3, 15, 22, 40), load_type: 'Refrigerado', load_sum: 6, cities: 'La Cisterna, Lo Espejo', stops_amount: 7)
